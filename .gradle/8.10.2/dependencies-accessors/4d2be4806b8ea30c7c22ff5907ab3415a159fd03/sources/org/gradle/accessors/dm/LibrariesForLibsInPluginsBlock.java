...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ReadiumLibraryAccessors laccForReadiumLibraryAccessors = new ReadiumLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>readium</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ReadiumLibraryAccessors getReadium() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForReadiumLibraryAccessors;
    }
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>navigation</b> with <b>androidx.hilt:hilt-navigation-fragment</b> coordinates and
     ...
     */
    @Deprecated
    public static class ReadiumLibraryAccessors extends SubDependencyFactory {

        public ReadiumLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>navigator</b> with <b>org.readium.kotlin-toolkit:readium-navigator</b> coordinates and
         * with version reference <b>readium</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getNavigator() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("readium.navigator");
        }

        /**
         * Dependency provider for <b>shared</b> with <b>org.readium.kotlin-toolkit:readium-shared</b> coordinates and
         * with version reference <b>readium</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getShared() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("readium.shared");
        }

        /**
         * Dependency provider for <b>streamer</b> with <b>org.readium.kotlin-toolkit:readium-streamer</b> coordinates and
         * with version reference <b>readium</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getStreamer() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("readium.streamer");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseCrashPlugin</b> with value <b>3.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseCrashPlugin() { return getVersion("firebaseCrashPlugin"); }
        ...
        /**
         * Version alias <b>pdfViewer</b> with value <b>2.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>readium</b> with value <b>3.0.0-beta.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getReadium() { return getVersion("readium"); }
    ...
    public static class FirebasePluginAccessors extends PluginFactory {
        ...
        /**
         * Group of plugins at <b>plugins.firebase.crashlytics</b>
         */
    ...
    public static class FirebaseCrashlyticsPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>firebase.crashlytics.plugin</b> with plugin id <b>com.google.firebase.crashlytics</b> and
         * with version reference <b>firebaseCrashPlugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
