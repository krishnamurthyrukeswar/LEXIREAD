...
public abstract class Hilt_AnnotationsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnnotationsFragment() {
    super();
  }

  Hilt_AnnotationsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnnotationsFragment_GeneratedInjector) this.generatedComponent()).injectAnnotationsFragment(UnsafeCasts.<AnnotationsFragment>unsafeCast(this));
    }
  }
