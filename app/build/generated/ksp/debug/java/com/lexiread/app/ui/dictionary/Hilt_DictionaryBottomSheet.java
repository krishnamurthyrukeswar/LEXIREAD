...
public abstract class Hilt_DictionaryBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DictionaryBottomSheet() {
    super();
  }

  Hilt_DictionaryBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DictionaryBottomSheet_GeneratedInjector) this.generatedComponent()).injectDictionaryBottomSheet(UnsafeCasts.<DictionaryBottomSheet>unsafeCast(this));
    }
  }
