...
public abstract class Hilt_ReaderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReaderFragment_GeneratedInjector) this.generatedComponent()).injectReaderFragment(UnsafeCasts.<ReaderFragment>unsafeCast(this));
    }
  }
